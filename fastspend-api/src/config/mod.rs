...
pub use from_file::STATIC_CONFIG;
...
impl Config {
    ...
    pub fn register_payee_name(&mut self, alias: String, name: String) -> () {
        self.register_payee(alias, None, Some(name));
    }
